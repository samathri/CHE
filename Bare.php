...
<div class="mobile-sidebar-menu mt-4">
  ...
  <div class="container text-center mt-5">
    <h1 class="title">BARENaked Rings</h1>
    <div class="line mx-auto"></div>

    <p class="description mt-4">
     Made with repeated hammering and really hot fire,our BARENaked rings are honestly beautiful,and they'll never go out & style!
    </p>
