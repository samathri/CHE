   ...
   <div id="cartSidebar" class="sidebar">
    ...
    <div class="container-fluid">
        ...
        <div class="reset-container text-center mt-5">
            ...
            <p>We’ll send you an email to reset your <br> password</p>
            <form method="POST" class="reset-form" action="send-password-reset.php">
              <div class="form-group">
                <input type="email" name="email" class="form-control" placeholder="Email" required>
              </div>
              <button type="submit" class="btn btn-dark btn-block">SUBMIT</button>
              <a href="#" class="btn btn-cancel mt-3">Cancel</a>
            </form>
        </div>
        <br>
