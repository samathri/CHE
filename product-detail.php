...
<div class="checkout-container mt-4 container">
    <!-- Product Listing -->
    <div class="checkout-product-listing">
        <?php if (isset($_SESSION['cart']) && !empty($_SESSION['cart'])): ?>
            <div class="cart-title"><center>Your Cart</center></div>
            ...
            foreach ($_SESSION['cart'] as $index => &$item):
                ...
                $total += $item_total; // Add item total to the total sum
            ?>
            <div class="checkout-product-item d-flex align-items-center mb-3">
                <img src="<?php echo $item['image']; ?>" alt="Item Image" class="checkout-product-image">
                <div class="checkout-product-details flex-grow-1">
                    <p class="checkout-product-name"><?php echo htmlspecialchars($item['name']); ?></p>
                    <p class="checkout-product-size">Size: <?php echo htmlspecialchars($item['size']); ?></p>
                </div>
                <div class="checkout-quantity-wrapper d-flex">
                    <button class="btn btn-sm quantity-decrease" data-index="<?php echo $index; ?>" data-unit-price="<?php echo $price; ?>">-</button>
                    <input type="number" class="form-control form-control-sm text-center quantity-input" value="<?php echo $quantity; ?>" min="1" data-index="<?php echo $index; ?>" data-unit-price="<?php echo $price; ?>">
                    <button class="btn btn-sm quantity-increase" data-index="<?php echo $index; ?>" data-unit-price="<?php echo $price; ?>">+</button>
                </div>
                <div class="checkout-product-price ms-3">Rs <?php echo number_format($price, 2); ?></div>
                <button class="checkout-remove-btn ms-3">&times;</button>
            </div>
            <?php endforeach; ?>

            <!-- Subtotal Section -->
            <div class="checkout-subtotal-section mt-4 d-flex justify-content-between">
                <div>Subtotal</div>
    ...
    <h2 class="customer-favorites" style="margin-top:50px;">You may also like</h2>
    
      <div class="container">
        <div class="row text-center">
          <div class="row mt-4">
            <!-- Repeat this block for items -->
      
            <!-- card 1 -->
            <div class="col-sm-6 col-md-4 mb-4" id="items-grid">
              <div class="card">
                <img src="images/image12.webp" class="card-img-top" alt="Item Image">
                <div class="card-body">
                  <p class="card-text"><span>Harmony Classic Arc Earrings</span> — <span>RS 18,700</span></p>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4 mb-4" id="items-grid">
              <div class="card">
                <img src="images/image14.webp" class="card-img-top" alt="Item Image">
                <div class="card-body">
                  <p class="card-text"><span>Beatitude Rings
                    </span> — <span>RS 15,700</span></p>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4 mb-4" id="items-grid">
              <div class="card">
                <img src="images/image15.webp" class="card-img-top" alt="Item Image">
                <div class="card-body">
                  <p class="card-text"><span>7th Heaven Classic Arc Earrings</span> — <span>RS 19,500.00</span></p>
                </div>
              </div>
            </div>
            <!-- Repeat ends -->
