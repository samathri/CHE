...
<div class="mobile-sidebar-menu mt-4">
 ...
 <nav class="navbar navbar-expand-md navbar-light bg-white">
  ...
  <main class="container text-center my-5">
    <h1>My Account</h1>
    <a href="./php/logout.php" class="text-decoration-none text-dark" >Log out</a>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 col-sm-12">
        <div class="border p-4">
          ...
          <p style="margin-left: -150px;"><?php echo $user["full_name"]; ?></p>
          <p style="margin-left: -110px;"><?php echo $user["user_email"]; ?></p>
          <a href="/Macherie/my_addr1.php" class="text-decoration-none fw-bold" style="margin-left: -85px;">View Addresses (1)</a>
        
      </div>
    </div>
    <div class="log-line2"></div>
