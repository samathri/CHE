...
<div class="mobile-sidebar-menu mt-4">
     ...
     <div class="container-fluid">
       ...
       <div class="collapse navbar-collapse" id="navbarNav">
         ...
         <ul class="icon-list">
           ...
           <li class="nav-item-2">
             <a class="nav-link" href="login.html"><i class="bi bi-person"></i></a>
           </li>
           <li class="nav-item-2">
  ...
  <div class="container-faq mt-5">
    ...
    <h1 class="title text-center">FAQ & Giving Rewards</h1>

    <div class="line mb-4 mx-auto"></div>

    <div class="quote-box mb-5" style="width: 400px;">
      <p class="quote-text">"I don’t want to just craft and sell beautiful jewelry. </br> I want to gift little bundles of happiness, everyday!"</p>
      <p class="quote-author">- Joe Han Lee</p>
    </div>

    <!-- First Subsection -->
    <div class="subsection">
      <h2 class="subsection-title">The Irresistible Rewards</h2>
      <div class="line mb-4 mx-auto"></div>
      ...
      <p class="rewards">Here are the first 5 rewards you can take advantage of!</p> 

        <p><strong>USD 10 off discount with orders above USD 67.</strong>
        </br>500 Giving Points
        </p>
        <p><strong>USD 10 off discount with orders above USD 67.</strong>
        </br>500 Giving Points
        </p>
        <p><strong>15% off coupon with orders above USD 67.</strong>
        </br>1500 Giving Points
        </p>
        <p><strong>USD 20 off discount with orders above USD 97.</strong>
        </br>2500 Giving Points
        </p>
        <p><strong>25% off coupon with orders above USD 97.</strong>
        </br>3000 Giving Points
        </p>
        <p><strong>30% off coupon with orders above USD 97.</strong>
        </br>6000 Giving Points
        </p>
    
        
      <p class="subsection-paragraph">
        With enough Giving Points, you can claim any Rewards as many times as you like. The Giving Points never expires, but once you claim a coupon, you’ll have to use the coupon within 3 days before the coupon expires.
        <a href="#" class="bold-link-1">Join The Irresistible Rewards by creating your FREE account here!</a>
      </p>
    </div>

    <!-- Second Subsection -->
    <div class="subsection mt-5">
      <h2 class="subsection-title">Why is it called Giving Points?</h2>
      <div class="line mb-4 mx-auto"></div>
      <p class="subsection-paragraph">
        The Giving Points and The Irresistible Rewards program is our way of giving back to you, our beloved Irresistible, and to aid Social Anxiety research and treatment, and mother earth. When you claim a reward, 100% of the proceeds go to the <a href="#" class="bold-link-2">Andrew Kukes Foundation for Social Anxiety, Worldwide Fund for Nature, and The Nature Conservancy.</a>
      </p>
      <p class="subsection-paragraph">
        We're a positive, pay-it-forward jewelry studio and <a href="#" class="bold-link-2">we champion social and environmental well-being through our craftsmanship.</a>
      </p>
    </div>
...
<!-- Third Subsection -->
<div class="subsection mt-5">
    <h2 class="subsection-title">What is our commitments to quality craftsmanship?</h2>
    <div class="line mb-4 mx-auto"></div>
    <p class="subsection-paragraph">
...
<div class="subsection mt-5">
    <h2 class="subsection-title">What is our commitments to quality craftsmanship?</h2>
    <div class="line mb-4 mx-auto"></div>
    <p class="subsection-paragraph"> 14K Gold-Filled jewelry are jewelry pieces made with a solid layer of 14K Gold that is bonded onto another metal, and is more than 100 times thicker than any high-quality Gold-plated jewelry.</p>

    <p class="subsection-paragraph"> So, if cared for, your 14K Gold-Filled jewelry can be worn for a very long time, without it tarnishing and wearing off. 14K Gold-Filled jewelry looks just like 14K Gold jewelry so it is an affordable alternative to solid 14K Gold jewelry. </p>
  </div>
...
<!-- Fifth Subsection -->
<div class="subsection mt-5">
    <h2 class="subsection-title">WHAT IS 14K GOLD-FILLED JEWELRY?</h2>
    <div class="line mb-4 mx-auto"></div>
    <p class="subsection-paragraph">14K Gold-Filled jewelry are jewelry pieces made with a solid layer of 14K Gold that is bonded onto another metal, and is more than 100 times thicker than any high-quality Gold-plated jewelry.</p>
...
<!-- sixth Subsection -->
<div class="subsection mt-5">
    <h2 class="subsection-title">Do Sterling Silver & Gold-Filled jewelry tarnish?</h2>
    <div class="line mb-4 mx-auto"></div>
    <p class="subsection-paragraph">Tarnish happens when the outermost layer of a metal undergoes a chemical reaction. Examples of common chemical reactions include exposure to humidity, skin perspiration (sweat), perfume, lotion, hairspray, and soap. </p>
    
    <p class="subsection-paragraph">❕ So, will Sterling Silver & Gold-Filled jewelry tarnish? The short answer is YES, as any metal that undergoes a chemical reaction will tarnish. Nevertheless, Sterling Silver & Gold-Filled have been used to craft jewelry for a long time because they’re less likely to tarnish. It does happen from time to time, and as everyone’s body chemistry is different, it is difficult to predict how your skin will react to the metal until you try it. The tarnish can easily be removed with a polishing cloth or liquid.</p>
  </div>


    <!-- Seventh Subsection -->
    <div class="subsection mt-5">
      <h2 class="subsection-title">How can you look after your jewelry?</h2>
      <div class="line mb-4 mx-auto"></div>
      <p class="subsection-paragraph">
      ...
      <p>AVOIDING TARNISH</p>
      <ul class="care-list">
        <li>Try not to wear your jewelry during exercise.</li>
        <li>Avoid contact between your jewelry and chemicals such as perfumes, laundry detergents, chlorine, and salt water.</li>
        <li>Store your jewelry in a cool, dry, and dark area.</li>
      </ul>
      <p>REMOVING TARNISH</p>
      <ul class="care-list">
        <li>Use Sterling Silver and Gold-filled cleaning and polishing clothes to clean your jewelry.</li>
        <li>Do not use tissue or paper towels as they may scratch the surface of the jewelry.</li>
      </ul>
    </div>

    <!-- Eighth Subsection -->
    <div class="subsection mt-5">
        <h2 class="subsection-title">Shopping during the holiday times?</h2>
        <div class="line mb-4 mx-auto"></div>
        <p class="subsection-paragraph">
        ...
        <ul class="care-list" >
          <li> Canada: order by Dec 6th</li>
          <li>USA: order by Dec 14th</li>
        </ul>
      </div>
