...
// Filter products by productCategory = 'necklace'
$base_condition = "WHERE productCategory = 'birthstone'";

if (isset($_GET["query"]) && !empty($_GET["query"])) {
  $search_query = $conn->real_escape_string($_GET["query"]);
  $base_condition .= " AND productName LIKE '%$search_query%'";
}

$sql = "SELECT * FROM products $base_condition";
...
$total_sql = "SELECT COUNT(*) AS total FROM products $base_condition";
...
<body>
  ...
  <div class="container text-center mt-5">
    ...
    <h1 class="title">Birthstone Jewelry</h1>
    ...
    <div class="d-flex justify-content-center align-items-center mt-3">
      ...
      <select id="browse" class="form-select w-auto" style="border-radius: 0;">
        ...
        <option>CHAIN BRACELETS</option>
        <option>DAINTY NECKLACES</option>
        <option>ON SALE</option>
        <option>THIN BANGLES</option>
      </select>
    </div>
