...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-light bg-white">
    ...
    <div class="container-fluid">
        ...
        <br><br>
        <div class="create-account-container text-center mt-5">
            <h2>Create Account</h2>
            <div class="create-line"></div>
            <br><br>
            <form class="create-account-form" id="registrationForm">
              <div class="form-group">
                  <input type="text" class="form-control" name="name" placeholder="Full Name" required>
              </div>
              <div class="form-group">
                  <input type="email" class="form-control" name="email" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}" title="Please enter a valid email address" required>
              </div>
              <div class="form-group position-relative">
                <input type="password" class="form-control" id="password" name="password" placeholder="Password" required>
                <i class="bi-eye-slash-fill position-absolute password-toggle" onclick="togglePassword('password')" style="right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer;"></i>
            </div>
            <div class="form-group position-relative">
                <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="Confirm Password" required>
                <i class="bi-eye-slash-fill position-absolute password-toggle" onclick="togglePassword('confirm_password')" style="right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer;"></i>
            </div>            
              <div id="errorMessage" class="alert alert-danger" style="display: none;"></div>
              <button type="submit" class="btn btn-dark btn-block">Sign Up</button>
          </form>
            <div class="additional-links mt-4">
                <a href="Home.php" class="d-block">Return to Store</a>
            </div>
