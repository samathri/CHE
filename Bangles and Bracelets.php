...
$base_condition = "WHERE productCategory = 'bangle' OR productCategory = 'Bracelets'";
...
<body>
  ...
  <div class="container text-center mt-5">
    ...
    <h1 class="title">Bangles and Bracelets</h1>
    ...
    <div class="d-flex justify-content-center align-items-center mt-3">
      ...
      <select id="browse" class="form-select w-auto" style="border-radius: 0;">
        ...
        <option>CHAIN BRACELETES</option>
        <option>ON SALE</option>
        <option>THING BANGLES</option>
      </select>
    </div>
