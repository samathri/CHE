 ...
 <nav class="navbar navbar-expand-md navbar-light bg-white">
  ...
  <div class="container-faq mt-5">
    ...
    <div class="line mb-4 mx-auto"></div>
      ...
      <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from irresistiblyminimal.com (the “Site”).</p>
  ...
  <div class="container-faq mt-5">
    ...
    <h1 class="title text-center">Shipping Policy</h1>

    <div class="line mb-4 mx-auto"></div>

<p>
  <img src="https://cdn.shopify.com/s/files/1/0249/8609/1617/files/Entirely_Handcrafted_by_Joe_Han_Lee-min.png" alt="" style="width: 700px;">
</p>

      <p>Hi there!</p>
        
      <p>Thank you for reading my shop policy. If you have any questions or comments, please email me at hello@irresistiblyminimal.com and I'll get back to you within 24 to 48 hours.
      </p>
      ...
      <p><strong>Processing times</strong><br>
        1 to 2 days. This is the time I take to craft your beautiful piece.
      </p>

      
      <p><strong>Estimated delivery times</strong><br>
        <ul>
          <li>United States: 3-7 business days</li>
          <li>Canada: 5-21 business days</li>
          <li>Europe: 10-21 business days</li>
          <li>Australia, New Zealand and Oceania: 10-21 business days</li>
          <li>Asia Pacific: 10-21 business days</li>
        </ul>
        I'll do my best to meet these delivery estimates, but I cannot guarantee them. Expedited shipping services are available at checkout.
      </p>

      
      <p><strong>Customs and import taxes</strong><br>
        You are responsible for any customs and import taxes that may apply. I'm not responsible for delays due to customs. I cannot issue a refund if you do not pick up the package from customs before the package is returned to me.
      </p>
      
      <a href="Terms of service.php" class="shipping" style="text-decoration: underline;"> Terms of Services </a> 
